...
function PcDetails() {
  ...
  const laptop = location.state.product; // Accéder directement à l'objet laptop
  const ficheTechniqueData = [
    ...
    {
      label: "  Systéme d'exploitation",
      value: laptop["Systéme d'exploitation"],
    },
    { label: "Garantie", value: laptop.Garantie },
  ];
    ...
    <div className="flex-details-1">
      ...
      <div className="flex-details-1-pc-features">
        <div className="flex-pc-features1">
          <p>Range</p>
          <p className="bold-features">{laptop["index"]}</p>
        </div>
      ...
      <div className="flex-details-1-Interested-btn">
        ...
        <button
          className="flex-details-1-btn"
          onClick={() => (window.location.href = laptop.Link)}
        >
          Check it out
        </button>
      </div>
